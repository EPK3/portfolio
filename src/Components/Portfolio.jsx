  ...
  return (
    <div id='portfolio' className='flex flex-col py-20 font-oxygen'>
      <div className='flex justify-center m-auto mb-20'>
        <Fade top>
          <h1 className='text-6xl md:text-8xl text-center text-gray font-oswald'>PORTFOLIO</h1>
        </Fade>
      </div>
      <Fade bottom>
      ...
      <Fade bottom>
        <div className='flex flex-row flex-wrap m-auto shadow-md rounded-md my-10 p-2 bg-[#fdfdfd] border-l-2 border-l-orange'>
          <div className='flex justify-center w-[350px] xl:w-[400px]'>
